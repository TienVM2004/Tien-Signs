...
//    }
    private void drawLandmarksOnCanvas(
        ...
        // Loop through all landmarks to find the bounding box.
        for (LandmarkProto.NormalizedLandmark landmark : handLandmarkList) {
        ...
        borderPaint.setColor(isLeftHand ? LEFT_HAND_HOLLOW_CIRCLE_COLOR : RIGHT_HAND_HOLLOW_CIRCLE_COLOR);
        borderPaint.setStrokeWidth(HOLLOW_CIRCLE_WIDTH);
        borderPaint.setStyle(Paint.Style.STROKE);

        // Draw the rectangle around the hand.
        canvas.drawRect(minX, minY, maxX, maxY, borderPaint);
    }
}